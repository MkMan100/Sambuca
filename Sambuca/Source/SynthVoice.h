...
struct SambucaOscillator 
{
    ...
    // Cambia dinamicamente la forma d'onda del modulo dsp::Oscillator
...
public:
    ...
    // Aggiorna frequenze e forme d'onda leggendo i parametri correnti (sia all'avvio nota che nel blocco)
    void updateOscillators()
    {
        ...
        for (int i = 0; i < 3; ++i)
        {
            ...
            if (pitchParam != nullptr)
            {
                ...
                // Calcolo della frequenza modificata dal pitch (Detune)
    ...
    void renderNextBlock (juce::AudioBuffer<float>& outputBuffer, int startSample, int numSamples) override
    {
        ...
        // Sincronizza Pitch e Waveform in tempo reale
        updateOscillators();
        ...
        for (int sample = 0; sample < numSamples; ++sample)
        {
            ...
            // Applica i volumi individuali prima del morphing macro
            s1 *= v1; s2 *= v2; s3 *= v3;
        ...
        // --- AGGIORNAMENTO FILTRO E SELETTORE TIPO ---
        ...
        // Imposta la modalità del LadderFilter (0: LP, 1: HP, 2: BP, Notch non supportato nativamente da Ladder, usiamo BP come fallback)
        switch (filterType)
        {
        ...
        // Applica l'LFO scalato in frequenza lineare (5000Hz max di escursione)
...
private:
    ...
    int currentMidiNote = 60; // Memorizza la nota corrente per il calcolo del detune
